DROP DATABASE student18;
CREATE DATABASE student18;
USE student18;
...
WHERE C1.meets_at = C2.meets_at AND E1.snum = E2.snum AND E1.snum = S.snum
AND E1.cname=C1.cname AND E2.cname = C2.cname AND E1.cname <> E2.cname
